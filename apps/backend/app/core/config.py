...
class Settings(BaseSettings):
    ...
    minio_endpoint: str = Field(default="http://49.247.14.186:9000", validation_alias="MINIO_ENDPOINT")
    ...
    minio_bucket: str = Field(default="image-archive-bot", validation_alias="MINIO_BUCKET")
    minio_secure: bool | None = Field(default=None, validation_alias="MINIO_SECURE")
